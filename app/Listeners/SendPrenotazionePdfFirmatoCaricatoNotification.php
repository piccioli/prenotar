...
class SendPrenotazionePdfFirmatoCaricatoNotification implements ShouldQueue
{
    public function __construct(private readonly GrSettings $grSettings) {}

    public function handle(PrenotazionePdfFirmatoCaricato $event): void
    {
        $emails = array_filter(
        ...
        Notification::route('mail', $emails)
            ->notify(new PrenotazionePdfFirmatoCaricatoNotification($event->prenotazione));
    }
}
