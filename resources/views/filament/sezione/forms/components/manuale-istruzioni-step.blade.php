        ...
        <div class="flex flex-1 flex-col gap-3">
            <div class="flex flex-col gap-1">
                <p class="text-sm font-extrabold text-gray-950 dark:text-white">
                    @if ($isChecked)
                        Manuale d'istruzioni confermato
                    @else
                        Prima di continuare: leggi il manuale d'istruzioni
                    @endif
                </p>
                <p class="text-xs leading-relaxed" style="color:var(--text-body)">
                    È un requisito di sicurezza obbligatorio, indipendente dalla torre che sceglierai nello step successivo.
                </p>
            </div>
            ...
            @if ($torre && filled($torre->manuale_pdf_path))
                ...
                >
                    ...
                    Visualizza/scarica il manuale d'istruzioni
                </a>
            @else
            ...
            >
                ...
                <span class="text-sm font-bold text-gray-950 dark:text-white">
                    Ho letto e compreso il manuale d'istruzioni
                </span>
            </label>
        </div>
    </div>
