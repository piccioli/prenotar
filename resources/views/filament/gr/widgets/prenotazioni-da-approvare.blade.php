<div class="space-y-4">
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2" style="max-width:760px">
        {{-- Card: Da approvare --}}
        ...
        <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
            ...
            <div class="divide-y" style="border-color:var(--stone-100)">
                @foreach($this->getPrenotazioniDaApprovare() as $pren)
                    ...
                    @endphp
                    <div class="grid grid-cols-1 items-center gap-2 px-6 py-4 sm:grid-cols-[2.4fr_1.8fr_1.2fr_1.1fr_130px] sm:gap-4">
                        <div class="min-w-0">
